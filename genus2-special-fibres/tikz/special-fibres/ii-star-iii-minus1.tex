...
\draw[thick,shorten >=2] (-1/3,0)--(113/30,0) node[inner sep=2pt,blue,above left,scale=0.8] {4} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_1$};
...
\draw[thick,shorten >=2] (8/5,4/5)--(161/30,4/5) node[inner sep=2pt,blue,above left,scale=0.8] {6} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_2$};
