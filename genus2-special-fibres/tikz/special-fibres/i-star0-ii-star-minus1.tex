...
\draw[thick,shorten >=2] (-1/3,0)--(31/6,0) node[inner sep=2pt,blue,above left,scale=0.8] {2} node[inner sep=2pt,below left,scale=0.8] {};
...
\draw[thick,shorten >=2] (12/5,6/5)--(37/6,6/5) node[inner sep=2pt,blue,above left,scale=0.8] {6} node[inner sep=2pt,below left,scale=0.8] {};
