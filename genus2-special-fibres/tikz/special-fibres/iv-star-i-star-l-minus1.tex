...
\draw[thick,shorten >=2] (-1/3,0)--(8,0) node[inner sep=2pt,blue,above left,scale=0.8] {2} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_1$};
\draw[shorten <=-3pt] (0,0)--node[inner sep=2pt,scale=0.8,blue,right] {1} (0,3/5);
\draw[blue!80!white,densely dashed] (17/15,0)--(17/15,4/5);\draw[thick,shorten >=2] (4/5,4/5)--(31/6,4/5) node[inner sep=2pt,blue,above left,scale=0.8] {3} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_2$};
