...
\draw[thick,shorten >=2] (4/15,0)--(289/60,0) node[inner sep=2pt,blue,above left,scale=0.8] {4} node[inner sep=2pt,below left,scale=0.8] {};
...
\draw[thick,shorten >=2] (11/5,21/20)--(197/30,21/20) node[inner sep=2pt,blue,above left,scale=0.8] {3} node[inner sep=2pt,below left,scale=0.8] {};
