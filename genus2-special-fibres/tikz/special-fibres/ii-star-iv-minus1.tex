...
\draw[thick,shorten >=2] (-1/3,0)--(253/60,0) node[inner sep=2pt,blue,above left,scale=0.8] {3} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_1$};
...
\draw[thick,shorten >=2] (8/5,21/20)--(161/30,21/20) node[inner sep=2pt,blue,above left,scale=0.8] {6} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_2$};
