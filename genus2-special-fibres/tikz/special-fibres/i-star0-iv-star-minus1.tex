...
\draw[thick,shorten >=2] (-1/3,0)--(137/30,0) node[inner sep=2pt,blue,above left,scale=0.8] {2} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_1$};
...
\draw[blue!80!white,densely dashed] (41/15,0)--(41/15,4/5);\draw[thick,shorten >=2] (12/5,4/5)--(203/30,4/5) node[inner sep=2pt,blue,above left,scale=0.8] {3} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_2$};
