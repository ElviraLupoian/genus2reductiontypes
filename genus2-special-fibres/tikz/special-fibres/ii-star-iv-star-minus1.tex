...
\draw[thick,shorten >=2] (4/15,0)--(157/30,0) node[inner sep=2pt,blue,above left,scale=0.8] {3} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_1$};
...
\draw[thick,shorten >=2] (35/12,33/20)--(401/60,33/20) node[inner sep=2pt,blue,above left,scale=0.8] {6} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_2$};
