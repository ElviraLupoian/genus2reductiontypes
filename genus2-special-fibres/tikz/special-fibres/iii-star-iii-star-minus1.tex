...
\draw[thick,shorten >=2] (4/15,0)--(149/30,0) node[inner sep=2pt,blue,above left,scale=0.8] {4} node[inner sep=2pt,below left,scale=0.8] {};
...
\draw[thick,shorten >=2] (11/5,6/5)--(179/30,6/5) node[inner sep=2pt,blue,above left,scale=0.8] {4} node[inner sep=2pt,below left,scale=0.8] {};
