...
\draw[thick,shorten >=2] (-1/3,0)--(37/5,0) node[inner sep=2pt,blue,above left,scale=0.8] {2} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_1$};
...
\draw[thick,shorten >=2] (4/5,6/5)--(137/30,6/5) node[inner sep=2pt,blue,above left,scale=0.8] {6} node[inner sep=2pt,below left,scale=0.8] {$\Gamma_2$};
