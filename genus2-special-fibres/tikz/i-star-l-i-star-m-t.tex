...
\begin{document}
% Namikawa--Ueno type: I^*_l-I^*_m-t
% Target MRNC type: I^*_l-t-I^*_m
% Adapted from Tim Dokchitser picture: I^*_{{\it n}}\e({\it m})I^*_{{\it r}}
% Parameter substitution: n -> l, m -> t, r -> m
...
\draw[thick,shorten >=2] (13/15,2)--(133/30,2) node[inner sep=2pt,blue,above left,scale=0.8] {2};
...
\draw (16/5,2) 
    ...
    ++(0,0.05)
    ++(0.19,-0.04)++(-0.04,-0.2)--++(-0.22,0.64);
\draw[thick,shorten >=2] (7/15,4)--(133/30,4) node[inner sep=2pt,blue,above left,scale=0.8] {2};
\draw[shorten <=-3pt] (4/5,4)--node[inner sep=2pt,scale=0.8,blue,right] {1} (4/5,23/5);
...
\draw (163/30,0) 
    ...
    ++(0,0.05)
    ++(0.19,-0.04)++(-0.04,-0.2)--++(-0.22,0.64);
\draw[thick,shorten >=2] (51/10,2)--(124/15,2) node[inner sep=2pt,blue,above left,scale=0.8] {2};
\draw[shorten <=-3pt] (187/30,2)--node[inner sep=2pt,scale=0.8,blue,right] {1} (187/30,13/5);
\draw[shorten <=-3pt] (211/30,2)--node[inner sep=2pt,scale=0.8,blue,right] {1} (211/30,13/5);
\end{tikzpicture}
\end{document}
