...
\begin{document}
% Namikawa--Ueno type: IX-3
% Target MRNC type: 5^{2,4,4}
% Adapted from Tim Dokchitser picture: 5^{2,4,4}
...
\draw[shorten <=-3pt, shorten >=-3pt] (2,0)--node[inner sep=2pt,scale=0.8,blue,right] {4} (2,3/5);
\draw[shorten <=-3pt, shorten >=-3pt] (2,3/5)--node[inner sep=2pt,scale=0.8,blue,above] {3} (7/5,3/5);
\draw[shorten <=-3pt, shorten >=-3pt] (7/5,3/5)--node[inner sep=2pt,scale=0.8,blue,left] {2} (7/5,6/5);
\draw[shorten <=-3pt] (7/5,6/5)--node[inner sep=2pt,scale=0.8,blue,above] {1} (2,6/5);
