...
\begin{document}
% Namikawa--Ueno type: I0-II^*-t
% Target MRNC type: I0-II^*-t
% Adapted from Tim Dokchitser picture: I_{g1}\e({\it n})II^*
...
\draw[thick,shorten >=2] (8/3,27/10)--(29/6,27/10) node[inner sep=2pt,blue,above left,scale=0.8] {1 \smash{g}1};
\end{tikzpicture}
\end{document}
