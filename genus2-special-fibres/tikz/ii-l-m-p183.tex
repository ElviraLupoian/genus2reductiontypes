...
\begin{document}
% Namikawa--Ueno type: II_{l-m} (p183)
% Target MRNC type: D-(l-1)-{2-2}-m-D
% Adapted from Tim Dokchitser picture: D\e({\it n})\e{2-2}({\it m})D
% Parameter substitution: n -> l-1, m -> m
