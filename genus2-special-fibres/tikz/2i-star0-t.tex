...
\begin{document}
% Namikawa--Ueno type: 2I^*0-t
% Target MRNC type: 2I^*0-t
% Adapted from Tim Dokchitser picture: [2]I^*_{0,{\it n}D}
...
\draw[thick,shorten >=2] (5/3,2)--(169/30,2) node[inner sep=2pt,blue,above left,scale=0.8] {4};
...
\draw[shorten <=-3pt] (22/5,2)--node[inner sep=2pt,scale=0.8,blue,right] {2} (22/5,13/5);
\end{tikzpicture}
\end{document}
