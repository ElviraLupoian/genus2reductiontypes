...
\begin{document}
% Namikawa--Ueno type: I0-I0-t
% Target MRNC type: I0-I0-t
% Adapted from Tim Dokchitser picture: I_{g1}\e({\it n})I_{g1}
% Parameter substitution: n -> t
\begin{tikzpicture}[xscale=0.57,yscale=0.62]
\draw[thick,shorten >=2] (-1/3,0)--(11/6,0) node[inner sep=2pt,blue,above left,scale=0.8] {1 \smash{g}1};
\draw (0,0) 
...
\draw[thick,shorten >=2] (-1/3,2)--(11/6,2) node[inner sep=2pt,blue,above left,scale=0.8] {1 \smash{g}1};
\end{tikzpicture}
\end{document}
