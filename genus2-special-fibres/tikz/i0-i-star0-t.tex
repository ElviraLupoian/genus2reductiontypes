...
\begin{document}
% Namikawa--Ueno type: I0-I^*0-t
% Target MRNC type: I0-I^*0-t
% Adapted from Tim Dokchitser picture: I_{g1}\e({\it n})I^*_0
...
\draw[thick,shorten >=2] (37/15,2)--(139/30,2) node[inner sep=2pt,blue,above left,scale=0.8] {1 \smash{g}1};
\end{tikzpicture}
\end{document}
