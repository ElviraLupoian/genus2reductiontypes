...
\begin{tikzpicture}[scale=0.5]
  ...
  \node[scale=0.6][above] at (N) {$\vdots
$};
...
$};
  ...
  \fill[black] (1A) circle (1.25pt);
    ...
    \coordinate (IVrC) at (-4.00, 3.00);
  \coordinate (IVrD) at (-2.00, 3.00);
  \coordinate (IVrE) at (-3.00, 4.00);
  \coordinate (IVrF) at (-3.00, 0.00);
  \coordinate (IVrG) at (-4.00, 2.00);
  \coordinate (IVrL) at (-2.00, 1.00);
  \coordinate (IVrI) at (-4.00, 1.00);
  \coordinate (IVrM) at (-2.00, 2.00);
  \coordinate (IVrD_1) at (-2.28, 2.35);
...
% old pic:
% Namikawa--Ueno type: IV-I^*_l-t
% Target MRNC type: IV-I^*_l-t
% Adapted from Tim Dokchitser picture: I^*_{{\it n}}\e({\it m})IV
...
% \draw[thick,shorten >=2] (5/3,2)--(157/30,2) node[inner sep=2pt,blue,above left,scale=0.8] {2};
...
% \draw (4,2) 
 ...
 %   ++(0,0.05)
 %   ++(0.19,-0.04)++(-0.04,-0.2)--++(-0.22,0.64);
% \draw[thick,shorten >=2] (19/15,4)--(157/30,4) node[inner sep=2pt,blue,above left,scale=0.8] {3};
% \draw[shorten <=-3pt] (8/5,4)--node[inner sep=2pt,scale=0.8,blue,right] {1} (8/5,23/5);
% \draw[shorten <=-3pt] (12/5,4)--node[inner sep=2pt,scale=0.8,blue,right] {1} (12/5,23/5);
% \end{tikzpicture}
