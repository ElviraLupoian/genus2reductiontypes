...
\begin{document}
% Namikawa--Ueno type: I_{l-m-n}
% Target MRNC type: I-l-m-n-I
% Adapted from Tim Dokchitser picture: I\e({\it n})\e({\it m})\e({\it r})I
% Parameter substitution: n -> n, m -> m, r -> l
\begin{tikzpicture}[xscale=0.57,yscale=0.62]
\draw[thick,shorten >=2] (-1/3,0)--(133/30,0) node[inner sep=2pt,blue,above left,scale=0.8] {1};
\draw (0,0) 
...
\draw (16/5,0) 
    ...
    ++(0,0.05)
    ++(0.19,-0.04)++(-0.04,-0.2)--++(-0.22,0.64);
\draw[thick,shorten >=2] (-1/3,2)--(133/30,2) node[inner sep=2pt,blue,above left,scale=0.8] {1};
\end{tikzpicture}
\end{document}
