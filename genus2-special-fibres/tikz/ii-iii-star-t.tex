...
\draw[thick,shorten >=2] (34/15,21/10)--(163/30,21/10) node[inner sep=2pt,blue,above left,scale=0.8] {6};
\draw[shorten <=-3pt] (17/5,21/10)--node[inner sep=2pt,scale=0.8,blue,right] {2} (17/5,27/10);
\draw[shorten <=-3pt] (21/5,21/10)--node[inner sep=2pt,scale=0.8,blue,right] {3} (21/5,27/10);
\end{tikzpicture}
\end{document}
