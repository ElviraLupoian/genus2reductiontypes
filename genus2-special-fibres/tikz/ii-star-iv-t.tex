...
% \draw[thick,shorten >=2] (28/15,27/10)--(151/30,27/10) node[inner sep=2pt,blue,above left,scale=0.8] {3};
% \draw[shorten <=-3pt] (11/5,27/10)--node[inner sep=2pt,scale=0.8,blue,right] {1} (11/5,33/10);
% \draw[shorten <=-3pt] (19/5,27/10)--node[inner sep=2pt,scale=0.8,blue,right] {1} (19/5,33/10);
% \end{tikzpicture}
