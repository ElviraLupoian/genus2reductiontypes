...
\begin{document}
% Namikawa--Ueno type: 2I^*_l-t
% Target MRNC type: [2]I^*_{l,tD}
% Adapted from Tim Dokchitser picture: [2]I^*_{{\it m},{\it n}D}
% Parameter substitution: m -> l, n -> t
\begin{tikzpicture}[xscale=0.57,yscale=0.62]
\draw[thick,shorten >=2] (-1/3,0)--(94/15,0) node[inner sep=2pt,blue,above left,scale=0.8] {4};
