...
\begin{document}
% Namikawa--Ueno type: I^*0-I^*0-t
% Target MRNC type: I^*0-I^*0-t
% Adapted from Tim Dokchitser picture: I^*_0\e({\it n})I^*_0
...
\draw[thick,shorten >=2] (37/15,2)--(193/30,2) node[inner sep=2pt,blue,above left,scale=0.8] {2};
...
\draw[shorten <=-3pt] (26/5,2)--node[inner sep=2pt,scale=0.8,blue,right] {1} (26/5,13/5);
\end{tikzpicture}
\end{document}
