...
\begin{document}
% Namikawa--Ueno type: I^*_l-I_m-t / I_l-I^*_m-t
% Target MRNC type: I^*_l-t-I_m / I_l-t-I^*_m
% Adapted from Tim Dokchitser picture: I_{{\it n}}\e({\it m})I^*_{{\it r}}
% Parameter substitution: n -> l, m -> t, r -> m
\begin{tikzpicture}[xscale=0.57,yscale=0.62]
\draw[thick,shorten >=2] (-0.33,0)--(6.06,0) node[inner sep=2pt,blue,above left,scale=0.8] {2};
...
\draw[scale=0.8] (2.2,2.5) ++(0.05,0.3) node[anchor=east,blue,scale=0.7] {1} ++(0.3,-0.45)--++(115:0.75)++(295:0.15)++(245:0.15)--++(65:0.75)++(245:0.15)++(180:0.15)--++(0:0.22) ++(0:0.15) node{$\cdot$} ++(0:0.15) node{$\cdot$} node[above=0.1,anchor=south,scale=0.7]{$l$}++(0:0.15) node{$\cdot$} ++(0:0.15) --++(0:0.22)++(180:0.15)++(115:0.15)--++(295:0.75)++(115:0.15)++(65:0.15)--++(245:0.75)++(0.3,0.45) node[anchor=west,blue,scale=0.7] {1};\draw (4.83,0) 
    ...
    ++(0,0.05)
    ++(0.19,-0.04)++(-0.04,-0.2)--++(-0.22,0.64);
\draw[thick,shorten >=2] (4.5,2)--(7.66,2) node[inner sep=2pt,blue,above left,scale=0.8] {2};
\draw[shorten <=-3pt] (5.63,2)--node[inner sep=2pt,scale=0.8,blue,right] {1} (5.63,13/5);
\draw[shorten <=-3pt] (6.43,2)--node[inner sep=2pt,scale=0.8,blue,right] {1} (6.43,13/5);
\end{tikzpicture}
\end{document}
