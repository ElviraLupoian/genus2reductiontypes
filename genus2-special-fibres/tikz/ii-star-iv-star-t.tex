...
\draw[shorten <=-3pt, shorten >=-3pt] (16/5,8/5)--node[inner sep=2pt,scale=0.8,blue,above] {3} (19/5,8/5);
\draw[shorten <=-3pt, shorten >=-3pt] (19/5,8/5)--node[inner sep=2pt,scale=0.8,blue,right] {4} (19/5,11/5);
\draw[shorten <=-3pt, shorten >=-3pt] (19/5,11/5)--node[inner sep=2pt,scale=0.8,blue,below left=-1pt and -1pt] {5} (67/20,53/20);
\draw[thick,shorten >=2] (181/60,53/20)--(371/60,53/20) node[inner sep=2pt,blue,above left,scale=0.8] {6};
\draw[shorten <=-3pt, shorten >=-3pt] (83/20,53/20)--node[inner sep=2pt,scale=0.8,blue,right] {4} (83/20,13/4);
\draw[shorten <=-3pt] (83/20,13/4)--node[inner sep=2pt,scale=0.8,blue,above] {2} (71/20,13/4);
\draw[shorten <=-3pt] (99/20,53/20)--node[inner sep=2pt,scale=0.8,blue,right] {3} (99/20,13/4);
\end{tikzpicture}
\end{document}
