...
\draw[thick,shorten >=2] (46/15,27/10)--(187/30,27/10) node[inner sep=2pt,blue,above left,scale=0.8] {4};
\draw[shorten <=-3pt, shorten >=-3pt] (21/5,27/10)--node[inner sep=2pt,scale=0.8,blue,right] {3} (21/5,33/10);
\draw[shorten <=-3pt, shorten >=-3pt] (21/5,33/10)--node[inner sep=2pt,scale=0.8,blue,above] {2} (18/5,33/10);
\draw[shorten <=-3pt] (18/5,33/10)--node[inner sep=2pt,scale=0.8,blue,left] {1} (18/5,39/10);
\draw[shorten <=-3pt] (5,27/10)--node[inner sep=2pt,scale=0.8,blue,right] {2} (5,33/10);
\end{tikzpicture}
\end{document}
