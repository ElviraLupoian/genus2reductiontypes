...
\begin{document}
% Namikawa--Ueno type: I0-I_l-t
% Target MRNC type: I0-I_l-t
% Adapted from Tim Dokchitser picture: I_{g1}\e({\it n})I_{{\it m}}
...
\draw[thick,shorten >=2] (2.1,2)--(4.27,2) node[inner sep=2pt,blue,above left,scale=0.8] {1 \smash{g}1};
\end{tikzpicture}
\end{document}
