...
\begin{document}
% Namikawa--Ueno type: I^*0-I_l-t
% Target MRNC type: I^*0-I_l-t
% Adapted from Tim Dokchitser picture: I_{{\it n}}\e({\it m})I^*_0
...
\draw[thick,shorten >=2] (2.1,2)--(6.07,2) node[inner sep=2pt,blue,above left,scale=0.8] {2};
...
\draw[shorten <=-3pt] (4.84,2)--node[inner sep=2pt,scale=0.8,blue,right] {1} (4.84,13/5);
\end{tikzpicture}
\end{document}
