...
\draw[thick,shorten >=2] (34/15,21/10)--(187/30,21/10) node[inner sep=2pt,blue,above left,scale=0.8] {2};
...
\draw[shorten <=-3pt] (5,21/10)--node[inner sep=2pt,scale=0.8,blue,right] {1} (5,27/10);
\end{tikzpicture}
\end{document}
