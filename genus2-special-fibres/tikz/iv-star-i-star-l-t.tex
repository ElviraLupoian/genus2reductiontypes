...
\draw[shorten <=-3pt, shorten >=-3pt] (4,7/2)--node[inner sep=2pt,scale=0.8,blue,below left=-1pt and -1pt] {2} (17/5,41/10);
\draw[thick,shorten >=2] (34/15,41/10)--(163/30,41/10) node[inner sep=2pt,blue,above left,scale=0.8] {3};
\draw[shorten <=-3pt, shorten >=-3pt] (13/5,41/10)--node[inner sep=2pt,scale=0.8,blue,right] {2} (13/5,47/10);
\draw[shorten <=-3pt] (13/5,47/10)--node[inner sep=2pt,scale=0.8,blue,above] {1} (2,47/10);
\draw[shorten <=-3pt, shorten >=-3pt] (21/5,41/10)--node[inner sep=2pt,scale=0.8,blue,right] {2} (21/5,47/10);
\draw[shorten <=-3pt] (21/5,47/10)--node[inner sep=2pt,scale=0.8,blue,above] {1} (18/5,47/10);
\end{tikzpicture}
\end{document}
