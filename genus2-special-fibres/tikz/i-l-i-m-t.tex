...
\begin{document}
% Namikawa--Ueno type: I_l-I_m-t
% Target MRNC type: I_l-t-I_m
% Adapted from Tim Dokchitser picture: I_{{\it n}}\e({\it m})I_{{\it r}}
...
\draw[thick,shorten >=2] (2.1,2)--(5.07,2) node[inner sep=2pt,blue,above left,scale=0.8] {1};
\draw[scale=0.8] (3.75,2.5) ++(0.05,0.3) node[anchor=east,blue,scale=0.7] {1} ++(0.3,-0.45)--++(115:0.75)++(295:0.15)++(245:0.15)--++(65:0.75)++(245:0.15)++(180:0.15)--++(0:0.22) ++(0:0.15) node{$\cdot$} ++(0:0.15) node{$\cdot$} node[above=0.1,anchor=south,scale=0.7]{$l$}++(0:0.15) node{$\cdot$} ++(0:0.15) --++(0:0.22)++(180:0.15)++(115:0.15)--++(295:0.75)++(115:0.15)++(65:0.15)--++(245:0.75)++(0.3,0.45) node[anchor=west,blue,scale=0.7] {1};\end{tikzpicture}
\end{document}
