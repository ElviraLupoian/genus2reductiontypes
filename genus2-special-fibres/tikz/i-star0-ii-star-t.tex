...
\begin{document}
% Namikawa--Ueno type: I^*0-II^*-t
% Target MRNC type: I^*0-II^*-t
% Adapted from Tim Dokchitser picture: I^*_0\e({\it n})II^*
...
\draw[thick,shorten >=2] (28/15,27/10)--(35/6,27/10) node[inner sep=2pt,blue,above left,scale=0.8] {2};
...
\draw[shorten <=-3pt] (23/5,27/10)--node[inner sep=2pt,scale=0.8,blue,right] {1} (23/5,33/10);
\end{tikzpicture}
\end{document}
