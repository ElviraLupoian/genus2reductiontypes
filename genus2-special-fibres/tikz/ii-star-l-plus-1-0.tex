...
\begin{document}
% Namikawa--Ueno type: II^*_{(l+1)-0}
% Target MRNC type: [2]I_{g1,(l+1)D}
% Adapted from Tim Dokchitser picture: [2]I_{g1,{\it n}D}
...
\draw[thick,shorten >=2] (5/3,2)--(23/6,2) node[inner sep=2pt,blue,above left,scale=0.8] {2 \smash{g}1};
\end{tikzpicture}
\end{document}
