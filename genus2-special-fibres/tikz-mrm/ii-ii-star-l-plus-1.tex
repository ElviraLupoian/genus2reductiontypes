...
% Namikawa--Ueno type: II-II^{*}_{l+1}
% Target MRNC type: II^{*}_{(l+1)D}
% Adapted from Tim Dokchitser picture: II_{{\it n}D}
% Parameter substitution: n -> l+1

\begin{tikzpicture}[xscale=0.57,yscale=0.62]

\draw[thick,shorten >=2] (-1/3,0)--(97/30,0)
  node[inner sep=2pt,blue,above left,scale=0.8] {6};
...
% curved D-component attached to the tail component labelled 2
\draw[thick,shorten >=-3pt]
  (-1/3,0)
    .. controls (0.5,2.35) and (1/2,3.05) ..
  (29/6,0)
    node[pos=0.65,right] {$D$};
