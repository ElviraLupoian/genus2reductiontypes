...
\begin{tikzpicture}[scale=0.5]
  ...
  \node[scale=0.6, font=\fontsize{8.5}{9}\selectfont][above] at (K_1) {$l-1$};
  \node[scale=0.6][above, text=blue, font=\fontsize{8.5}{9}\selectfont] at (G_1) {B};
  \node[scale=0.6][above, text=blue, font=\fontsize{8.5}{9}\selectfont] at (L) {B};
\end{tikzpicture}
