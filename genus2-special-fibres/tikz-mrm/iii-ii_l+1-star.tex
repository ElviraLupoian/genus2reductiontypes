...
\begin{tikzpicture}[scale=0.5]
  ...
  \coordinate (U) at (1.5, 3.05);
  \coordinate (V) at (-3.19, 2.10);
  \coordinate (W) at (-2.47, 2.90);
  ...
  \node[above] at (R) {$l+1
$};
  \node[above, text=blue] at (S) {$B$};
  \node[above, text=blue] at (T) {$B$};
  \node[above, text=blue] at (U) {$2
$};
  \node[above, text=blue] at (V) {$2$};
  \node[above, text=blue] at (W) {$2$};
